...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MalSentinal — Minor Project Presentation" },
      {
        name: "description",
        content: "Graph-based Android malware detection and family classification.",
      },
      { name: "author", content: "Lakshya Singh Kushwah" },
    ],
    links: [
